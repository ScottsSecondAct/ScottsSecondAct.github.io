...
```mermaid
graph TB
    subgraph "Building Macromolecules"
        A[Monomer 1<br/>-OH] --> C{Dehydration<br/>Synthesis}
        B[Monomer 2<br/>H-] --> C
        C -->|Removes H₂O<br/>Requires Energy| D[Polymer<br/>Monomer₁-Monomer₂]
        C -.->|Byproduct| E[H₂O Released]
    end
    
    subgraph "Breaking Down Macromolecules"
        D2[Polymer<br/>Monomer₁-Monomer₂] --> F{Hydrolysis}
        G[H₂O Added] --> F
        F -->|Consumes H₂O<br/>Releases Energy| H[Monomer 1<br/>-OH]
        F --> I[Monomer 2<br/>H-]
    end
    
    D -.->|Reverse<br/>Process| D2
...
```mermaid
mindmap
  root((Biological<br/>Macromolecules))
    Carbohydrates
      ...
      Polymers: Polysaccharides
        ...
        Chitin - arthropod/fungal structure
      Bond: Glycosidic
      Energy: 4.3 Kcal/g
    Proteins
...
```mermaid
graph LR
    subgraph "Carbon Bonding Patterns"
        C[Carbon Atom<br/>4 valence electrons] --> S[Single Bonds<br/>Tetrahedral<br/>Can rotate]
        C --> D[Double Bonds<br/>Planar<br/>No rotation]
        C --> T[Triple Bonds<br/>Linear<br/>No rotation]
    end
    
    subgraph "Isomer Types"
        I1[Same Formula<br/>C₄H₁₀] --> ST[Structural<br/>Isomers]
        ST --> B[Butane<br/>Linear chain]
        ST --> IB[Isobutane<br/>Branched chain]
        
        I2[Same Formula<br/>Same Bonds] --> GE[Geometric<br/>Isomers]
        GE --> CIS[Cis<br/>Groups same side<br/>Creates bend]
        GE --> TRANS[Trans<br/>Groups opposite<br/>Linear]
        
        I3[Chiral Carbon<br/>4 different groups] --> EN[Enantiomers<br/>Mirror images]
        EN --> L[L-form<br/>Used in proteins]
        EN --> DR[D-form<br/>Used in glucose]
    end
    
    style C fill:#FFD700
    style CIS fill:#98FB98
...
```mermaid
graph TD
    subgraph "Four Levels of Protein Structure"
        P1[Primary Structure<br/>Amino acid sequence<br/>Determined by DNA] --> P2[Secondary Structure<br/>α-helix and β-pleated sheet<br/>H-bonds in backbone]
        P2 --> P3[Tertiary Structure<br/>Overall 3D shape<br/>R group interactions]
        P3 --> P4[Quaternary Structure<br/>Multi-subunit arrangement<br/>Only for multi-chain proteins]
    end
    
    subgraph "Tertiary Forces"
        F1[Hydrophobic<br/>interactions]
        F2[Hydrogen bonds]
        F3[Ionic bonds]
        F4[Disulfide bonds<br/>Covalent - Cys only]
    end
    ...
    P3 -->|Temperature / pH<br/>change| DEN[Denaturation<br/>Loss of shape<br/>Loss of function]
    DEN -->|Remove agent| P3
    
    style P1 fill:#FFD700
    style P2 fill:#FFA500
    style P3 fill:#FF6347
    style P4 fill:#DC143C
    style DEN fill:#808080
```
...
```mermaid
graph TB
    subgraph "Phospholipid Molecule"
        HEAD[Phosphate Head<br/>Polar / Hydrophilic<br/>Faces water] --> GLYC[Glycerol<br/>Backbone]
        GLYC --> TAIL1[Fatty Acid Tail 1<br/>Nonpolar / Hydrophobic]
        GLYC --> TAIL2[Fatty Acid Tail 2<br/>Nonpolar / Hydrophobic]
    end
    
    subgraph "Bilayer in Cell Membrane"
        EXT[Extracellular Fluid] --> OH1[Hydrophilic Heads<br/>Outer Layer]
        OH1 --> HT[Hydrophobic Tails<br/>Interior - No Water]
        HT --> IH1[Hydrophilic Heads<br/>Inner Layer]
        IH1 --> INT[Intracellular Fluid]
    end
    
    style HEAD fill:#87CEEB
    style TAIL1 fill:#FFD700
    style TAIL2 fill:#FFD700
    style OH1 fill:#87CEEB
    style HT fill:#FFD700
    style IH1 fill:#87CEEB
```
